...
Write a function named removeVowels that takes in a string and returns a new string where all the vowels (A, E, I, O,U) of the original string have been removed.
...
const extractVowels = (str) => {
  ...
  arrVows.sort();
  arr.push(strArr.join(''), arrVows.join(''));
  return arr;
};
